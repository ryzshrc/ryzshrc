# diagnostics.zsh
#
# Diagnostic and debugging support for ry-zsh-rc
...
# ry-zsh-rc, zsh, and the user's system. This is intended to provide a
...
#
# This is intended to be widely portable, and run anywhere that ry-zsh-rc does.
...
function _ryz_diag_dump_one_big_text() {
  ...
  builtin echo ry-zsh-rc diagnostic dump
  builtin echo
  ...
  builtin echo ry-zsh-rc installation:
  command ls -ld ~/.z*
  command ls -ld ~/.oh*
  builtin echo
  builtin echo ry-zsh-rc git state:
  ...
  if [[ -e $ZSH_CUSTOM ]]; then
    ...
    builtin echo "ry-zsh-rc custom dir:"
