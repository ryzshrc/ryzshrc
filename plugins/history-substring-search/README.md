...
[4]: https://github.com/robbyrussell/ry-zsh-rc/pull/215
...
Using [Oh-my-zsh](https://github.com/robbyrussell/ry-zsh-rc):

1. Clone this repository in ry-zsh-rc's plugins directory:

        git clone https://github.com/zsh-users/zsh-history-substring-search ${ZSH_CUSTOM:-~/.ry-zsh-rc/custom}/plugins/zsh-history-substring-search
...
* January 2011: Suraj N. Kurapati (@sunaku) extracted this script from
  ...
  [ry-zsh-rc plugin][4] and as an independently loadable [ZSH script][5].
