...
Assume that you have previously visited directory `~/.ry-zsh-rc/plugins`. From any folder in your command line, you can quickly access it by using a regex match to this folder:
