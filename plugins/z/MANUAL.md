...
### For [RyZshrc](http://ryzrc.sh/) users

Zsh-z is now included as part of RyZshrc! As long as you are using an up-to-date installation of RyZshrc, you can activate Zsh-z simply by adding `z` to your `plugins` array in your `.zshrc`, e.g.,
...
If, however, you prefer always to use the latest version of Zsh-z from the `agkozak/zsh-z` repo, you may install it thus:
    ...
    git clone https://github.com/agkozak/zsh-z ${ZSH_CUSTOM:-~/.ry-zsh-rc/custom}/plugins/zsh-z
