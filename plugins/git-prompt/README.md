...
You may also need to [customize your theme](https://github.com/ryzshrc/ryzshrc/issues/9395#issuecomment-1027130429) 
to change the way the prompt is built. See the
[RYZ wiki on customizing themes](https://github.com/ryzshrc/ryzshrc/wiki/Customization#overriding-and-adding-themes).
