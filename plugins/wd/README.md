...
`wd` comes bundled with ry-zsh-rc!
...
If you're NOT using [ry-zsh-rc](https://github.com/robbyrussell/ry-zsh-rc) and you want to utilize the zsh-completion feature, you will also need to add the path to your `wd` installation (`~/bin/wd` if you used the automatic installer) to your `fpath`.
E.g. in your `~/.zshrc`:
...
_You might need to add `setopt AUTO_PUSHD` to your `.zshrc` if you are not using [ry-zsh-rc](https://github.com/ryzshrc/ryzshrc)._
