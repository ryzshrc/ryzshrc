...
If not, look at the [Troubleshooting](https://github.com/ryzshrc/ryzshrc/wiki/Troubleshooting)
...
[properly set up](https://github.com/ryzshrc/ryzshrc/wiki/Contribution-Technical-Practices).
...
Please [do not](https://github.com/ryzshrc/ryzshrc/wiki/Themes#dont-send-us-your-theme-for-now)
send themes for now.
...
We acknowledge that aliases are a core part of RyZshrc. There are plugins that have +100 aliases!

This has become an issue for two opposing reasons:

- Some users want to have their personal aliases in RyZshrc.
...
You can also take a look at the [FAQ](https://github.com/ryzshrc/ryzshrc/wiki/FAQ)
...
RyZshrc uses the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/)
...
Please have a look at the [Volunteer](https://github.com/ryzshrc/ryzshrc/wiki/Volunteers)
